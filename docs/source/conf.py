# -*- coding: utf-8 -*-
#
# HTM Gel documentation build configuration file, created by
...
from sphinx_helpers import get_release, get_version, lucidchart, wistia, vimeo
...
# Collection the document tree into LaTeX files. List of tuples
# (source start file, target name, title,
#  author, documentclass [howto, manual, or own class]).
latex_documents = [
    (master_doc, 'BasisHR.tex', u'HTM Gel Documentation',
     u'Shawn Davis', 'manual'),
]
...
man_pages = [
    (master_doc, 'basishr', u'HTM Gel Documentation',
     [author], 1)
]
...
# Collection the document tree into Texinfo files. List of tuples
# (source start file, target name, title, author,
#  dir menu entry, description, category)
texinfo_documents = [
    (master_doc, 'BasisHR', u'HTM Gel Documentation',
     author, 'BasisHR', 'One line description of project.',
     'Miscellaneous'),
]
